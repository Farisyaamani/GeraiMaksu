...
if (isset($_SESSION['email'])) { 
    $email = $_SESSION['email'];
        ...
        // Create the orderFormC table if it doesn't exist
        $sql = "CREATE TABLE IF NOT EXISTS orderFormC (
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            // Insert the form data into the orderFormC table, including the email and order_id
            $insertSql = "INSERT INTO orderFormC (order_id, name, package, reservation_date, quantity, phone_number, location, email) 
