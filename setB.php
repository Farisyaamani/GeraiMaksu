...
<nav class="navbtn">
  ...
  <button class="nav-item" onclick="window.location.href='review2.php';">REVIEW</button>
      ...
      <p class="menus">
        <i style="text-align: center; font-weight: bold;">SET B</i>
        <br><br><br>
      ...
      <div class="orderForm">
        <form id="myForm" name="myForm" method="post" class="form" action="pro_setB.php">
          ...
          <input type="number" placeholder="Enter Quantity" name="quantity" id="quantity" min="51" max="100" required>
          <br>
