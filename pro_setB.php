...
if (isset($_SESSION['email'])) { 
    $email = $_SESSION['email'];
        ...
        // Create the orderFormB table if it doesn't exist
        $sql = "CREATE TABLE IF NOT EXISTS orderFormB (
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            // Insert the form data into the orderFormB table, including the email and order_id
            $insertSql = "INSERT INTO orderFormB (order_id, name, package, reservation_date, quantity, phone_number, location, email) 
